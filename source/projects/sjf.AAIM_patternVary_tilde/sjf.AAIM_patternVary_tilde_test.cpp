...
#include "sjf.AAIM_patternVary_tilde.cpp"    // need the source of our object so that we can access it
...
//
//        test_wrapper<sjf_AAIM_rhythmGen_tilde> an_instance;
//        sjf_AAIM_rhythmGen_tilde&              my_object = an_instance;
//
